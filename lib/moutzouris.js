...
/*function reset_board() {
	$.ajax({url: "moutzouris.php/board/", headers: {"X-Token": me.token}, method: 'POST',  success: fill_board_by_data });
	$('#move_div').hide();
...
function fill_board_by_data(data) {
	...
	$.ajax({url: "moutzouris.php/players/"+p_id, 
			method: 'PUT',
			dataType: "json",
			headers: {"X-Token": me.token},
			contentType: 'application/json',
			data: JSON.stringify( {p_username: $('#p_username').val(), p_id: p_id}),
...
/*function do_move() {
	...
	$.ajax({url: "moutzouris.php/board/piece/"+a[0]+'/'+a[1], 
			method: 'PUT',
			dataType: "json",
			contentType: 'application/json',
