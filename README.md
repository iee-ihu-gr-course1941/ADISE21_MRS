...
Ένας πίνακας που περιέχει τις 41 κάρτες που χρειάζονται για το παιχνίδι μουτζούρης.
| Field | Description |
| --- | --- |
|`c_id`|Μοναδικό ID για κάθε κάρτα|
|`c_name`| Όνομα κάρτας|
...
### Game_status
Ένας πίνακας που περιέχει στοιχεία για την κατάσταση του παιχνιδιού.
| Field | Description |
| --- | --- |
...
### Players
Ένας πίνακας που περιέχει στοιχεία του κάθε παίκτη.
| Field | Description |
| --- | --- |
